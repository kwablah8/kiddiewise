...
const TONE_CLASS: Record<SectionTone, string> = {
  ...
  // Crimson → deep-crimson band: the brand anchor colour. Light text (AA on both stops).
...
/**
 * The marketing layout wrapper. Every band on the public site is a <Section>, which gives it
 * a tone (white / warm gold-tint / crimson brand band / gold accent band), consistent editorial
