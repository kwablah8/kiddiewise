  ...
  return (
    <Section tone="brand" className="overflow-hidden pt-36 pb-28 sm:pt-44 sm:pb-36">
      <div className="relative max-w-2xl reveal">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 font-mono text-[11px] uppercase tracking-[0.2em] text-white/80">
          {eyebrow}
        </span>
        <h1 className="mt-6 text-[clamp(2.25rem,5vw,3.5rem)] font-semibold leading-[1.05] tracking-[-0.02em] text-white">
          {title}
        </h1>
        <p className="mt-5 max-w-xl text-lg leading-relaxed text-white/80">{blurb}</p>
